...
insert into expected_protected_tables (table_name) values
  ...
  ('project_work_item_counters'),
  ('owner_absence_policies'),
  ('company_continuity_events'),
...
begin
  ...
  where table_schema='public'
    and table_name in (
      ...
      'project_number_counters','project_work_item_counters',
      'owner_absence_policies','company_continuity_events',
