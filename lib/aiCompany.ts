...
—
⚠️ هذه التقارير خطة عمل مقترحة من فريق الذكاء الاصطناعي — لا يُعد أي بند
"منفذاً فعلياً" إلا بعد ظهوره مكتملاً في قائمة التنفيذ، وأي خطوة تتطلب
مبلغاً مالياً لا تُنفَّذ قبل اعتمادها من مركز القرار.
`.trim();
}
